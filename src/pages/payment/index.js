...
const Payment = () => {
  ...
  const savingTotal = 20;
  const pickupTotal = 99;
  const taxTotal = (total * 10) / 100
  const endTotal = total + taxTotal + pickupTotal
    ...
    <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div className="mx-auto max-w-5xl">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Complete your order</h2>
          <form className="mt-8">
            <div>
              <h3 className="text-base text-gray-800 mb-4 dark:text-white">Personal Details</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <input type="text" placeholder="First Name"
                    className="px-4 py-3 bg-gray-100 focus:bg-transparent text-gray-800 w-full text-sm rounded-md focus:outline-blue-600 dark:bg-gray-700" />
                </div>
            ...
            <div className="mt-8">
              <h3 className="text-base text-gray-800 mb-4 dark:text-white">Shipping Address</h3>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
        ...
        <div className="mx-auto max-w-5xl mt-4">
          ...
          <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
            ...
            >
              ...
              <button
                type="submit"
                className="flex w-full items-center justify-center rounded-lg  px-5 py-2.5 text-sm font-medium  bg-primeColor text-white hover:bg-black focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 dark:bg-white dark:text-black"
