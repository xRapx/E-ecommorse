        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          <figure className="rounded-2xl bg-white shadow-lg ring-1 ring-gray-900/5 sm:col-span-2 xl:col-start-2 xl:row-end-1">
            <blockquote className="p-6 text-lg font-semibold leading-7 tracking-tight text-gray-900 sm:p-12 sm:text-xl sm:leading-8">
              <p>
                “Learn from yesterday , live for taday , hope for tomorrow. The
          ...
          <div className="space-y-8 xl:contents xl:space-y-0">
            <div className="space-y-8 xl:row-span-2">
              <figure className="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                <blockquote className="text-gray-900">
                  <p>
                    “Junius is against racism and this club has to celebrate
                ...
                <figcaption className="mt-6 flex items-center gap-x-4">
                  ...
                  />
                  <div>
                    <div className="font-semibold">Juventus's old lady</div>
                  </div>
                </figcaption>
              </figure>
            </div>
            <div className="space-y-8 xl:row-start-1">
              <figure className="rounded-2xl bg-white p-6 shadow-lg ring-1 ring-gray-900/5">
                <blockquote className="text-gray-900">
                  <p>
                    “Everithing on earth is a game. A passing thing. We all end
                    up dead. We all end up the same, don't we ?”
                  </p>
                </blockquote>
                <figcaption className="mt-6 flex items-center gap-x-4">
                  <img
